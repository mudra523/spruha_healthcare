                    ...
                    <div class="col-md-3">
                        <nav class="navbar bg-light">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-plus-square"></i>New in stock</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-female"></i>Category</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-child"></i>Covid Care</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-tshirt"></i>Mother and Child care</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
        ...
        <div class="brand">
            <div class="container-fluid">
                <div class="brand-slider">
                    <div class="brand-item"><img src="image/brand-1.png" alt=""></div>
                    <div class="brand-item"><img src="image/brand-2.png" alt=""></div>
                    <div class="brand-item"><img src="image/brand-3.png" alt=""></div>
                    <div class="brand-item"><img src="image/brand-4.png" alt=""></div>
                    <div class="brand-item"><img src="image/brand-5.png" alt=""></div>
                    <div class="brand-item"><img src="image/brand-6.png" alt=""></div>
                </div>
            </div>
        </div>
        <!-- Brand End -->           
                ...
                <div class="row align-items-center product-slider product-slider-4">
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="image/product-6.jpg" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="image/product-7.jpg" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="image/product-8.jpg" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="image/product-9.jpg" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-3">
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="image/product-10.jpg" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
