...
{	
	...
	else if($ordertype = "Rent")
	{
		...
		$sql = "INSERT INTO `order`(UserID,PaymentID,Orderdate,Isshipping,Shipment,Needtechnician,Address)VALUES($uId,$payment,$Orderdate,1,$shipmentId,$needtechnician,'$address')";
		...
		while($data=mysqli_fetch_array($resultcart))
		{
			...
			//echo $totalAmount;
			$sql2 = "INSERT INTO orderdetails(EquipmentID,OrderID,Ordertype,Qty,Price)VALUES('$eqid',$iorderid,$ordertypeId,1,'$price')";
		...
		//echo $totalAmount;
		$updateSql = "Update order set Totalamt = $totalAmount WHERE ID = $iorderid";
		
		//echo $updateSql;
		$result4 = mysqli_query($conn, $updateSql);
		echo '<script>window.location.href = "vieworderuser.php";</script>';
                            ...
                            <div class="billing-address">
                                <h2>Billing Address</h2>
									...
									<div class="col-md-12">
										...
										<!--The order date should contain system default value not a calender, as of now for showing input calendar is set-->
										<div class="col-md-6">
                                        <label>Orderdate</label>
                                        <input class="form-control" type="date" placeholder="Orderdate" name="Orderdate">
                                    </div>
