...
$sqlEquipmentDetail="SELECT * from equipment where ID=64";
                        ...
                        <div class="product-detail-top">
							...
							?>
                                    ...
                                    <div class="product-slider-single-nav normal-slider">
                                        <div class="slider-nav-img"><img src="img/Breastpump.jpg" alt="Product Image"></div>
										<div class="slider-nav-img"><img src="img/Breastpump.jpg" alt="Product Image"></div>
										<div class="slider-nav-img"><img src="img/Breastpump.jpg" alt="Product Image"></div>
										<div class="slider-nav-img"><img src="img/Breastpump.jpg" alt="Product Image"></div>
                        ...
                        <div class="row product-detail-bottom">
                            <div class="col-lg-12">
                                <ul class="nav nav-pills nav-justified">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#reviews">Specification</a>
                                    </li>
                                </ul>
                            ...
                            <div class="row align-items-center product-slider product-slider-3">
                                <div class="col-lg-3">
                                    <div class="product-item">
                                        <div class="product-title">
                                            <a href="#">Ambulatory BP Machine</a>
                                            <div class="ratting">
                                        ...
                                        <div class="product-image">
                                            <a href="product-detail.html">
                                                <img src="img/BP1.jpg" alt="Product Image">
                                            </a>
                                ...
                                <div class="col-lg-3">
                                    <div class="product-item">
                                        ...
                                        <div class="product-image">
                                            <a href="product-detail.html">
                                                <img src="img/mag3.jpg" alt="Product Image">
                                            </a>
                                            <div class="product-action">
                                                <a href="#"><i class="fa fa-cart-plus"></i></a>
                                                <a href="#"><i class="fa fa-heart"></i></a>
                                ...
                                <div class="col-lg-3">
                                    <div class="product-item">
                                        <div class="product-title">
                                            <a href="#">Dream Station Auto CPAP</a>
                                            <div class="ratting">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                        ...
                                        <div class="product-image">
                                            <a href="product-detail.html">
                                                <img src="img/CPAP1.jpg" alt="Product Image">
                                            </a>
                                            <div class="product-action">
                                                <a href="#"><i class="fa fa-cart-plus"></i></a>
                                                <a href="#"><i class="fa fa-heart"></i></a>
                                ...
                                <div class="col-lg-3">
                                    <div class="product-item">
                                        <div class="product-title">
                                            <a href="#">Astral - 150 Ventilator</a>
                                            <div class="ratting">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                        ...
                                        <div class="product-image">
                                            <a href="product-detail.html">
                                                <img src="img/Ven1.jpg" alt="Product Image">
                                            </a>
                                            <div class="product-action">
                                                <a href="#"><i class="fa fa-cart-plus"></i></a>
                                                <a href="#"><i class="fa fa-heart"></i></a>
                                ...
                                <div class="col-lg-3">
                                    <div class="product-item">
                                        ...
                                        <div class="product-image">
                                            <a href="product-detail.html">
                                                <img src="img/commod1.jpg" alt="Product Image">
                                            </a>
                                            <div class="product-action">
                                                <a href="#"><i class="fa fa-cart-plus"></i></a>
                                                <a href="#"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="col-lg-4 sidebar">
                        ...
                        <div class="sidebar-widget widget-slider">
                            <div class="sidebar-slider normal-slider">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#">Breast Pump (Manual/Electric)</a>
                                        <div class="ratting">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.html">
                                            <img src="img/Breastpump.jpg" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="#"><i class="fa fa-cart-plus"></i></a>
                                            <a href="#"><i class="fa fa-heart"></i></a>
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="product-image">
                                        <a href="product-detail.html">
                                            <img src="img/Scale.jpg" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                                            <a href="#"><i class="fa fa-cart-plus"></i></a>
                                            <a href="#"><i class="fa fa-heart"></i></a>
