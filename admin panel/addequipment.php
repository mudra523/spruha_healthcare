...
{	//echo "Done";
	...
	$sql = "INSERT INTO equipment(CategoryID,Name,Qty,Price,Description,Specification,Color,Company,Image1,Image2,Image3) VALUES
	('$categoryID','$name','$quantity','$price','$desc','$spec','$colour','$company','$img1','$img2','$img3')";
