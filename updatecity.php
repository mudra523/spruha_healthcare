...
{	
	...
	$ucity=$_POST['Cityname'];
	
	// update user data
	
	$sql = "UPDATE city SET Cityname='$ucity' WHERE ID='$Id'";
                    ...
                    <div class="col-lg-12">
                        <div class="login-form">
                            <div class="row">
                                <div class="col-md-6">
                                    <label>City</label>
                                    <input class="form-control" name="Cityname" type="text" placeholder="City" required value="<?php echo htmlentities($Cityname); ?>">
                                </div>
								<div class="col-md-6">
